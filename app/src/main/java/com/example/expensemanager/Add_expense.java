    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Add_expense.this, new TimePickerDialog.OnTimeSetListener() {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(dt.isEmpty() || tm.isEmpty() || amt==0 || desc.isEmpty()) {
                    ...
                    boolean isInserted=exdb.insertExpenseData(dt,tm,amt,desc);
                    if(isInserted = true) {
